...
The overhead from the shell modules is small on all CPU, GPU and RAM fronts, since they're built to be optimized, and only run when necessary.


This is still a work in progress, but is currently stable and functional for full usage.


<img width="1920" height="1080" alt="revolte-screenshot" src="https://github.com/user-attachments/assets/e4c678f1-3e21-41a7-ba72-f6a03ec27b45" />
